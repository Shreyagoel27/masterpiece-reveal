export const imageInfo = [
  ...
  {
    transform: "scale(3) translate(-10.5%, -31.5%)",
  ...
  {
    transform: "scale(3.5) translate(0%,-10.5%)",
  ...
  {
    transform: "scale(4.5) translate(-5.5%, 6%)",
  ...
  {
    transform: "scale(5) translate(-5.5%, 0%)",
    info: "Shah jahan is wearing a weighty pink coat, called a jama, festooned with flowers, belted with sash of gold and orange. The coat is tied to the right, in Muslim fashion.(Hindus tied their to the left.)",
  },
  {
    transform: "scale(5) translate(-5.5%, 9%)",
  ...
  {
    transform: "scale(3) translate(-5.5%, -15%)",
  ...
  {
    transform: "scale(4) translate(-5.5%, -15%)",
